		...
		var editor = (function(){
            return {
                ...
                appendHr : function(value) {
                    ...
                    switch(value) {
                        case 'hr1':
                            borderStyle = "#4B4F56 1px solid";
                            break;
                        case 'hr2':
                            borderStyle = "#4B4F56 1px dotted";
                            break;
                        case 'hr3':
                            borderStyle = "#4B4F56 1px dashed";
                            break;
                    }

                    var oHr = document.createElement("HR");
                    oHr.style.border = "#4B4F56 0px none";
        ...
        var toolBar = function() {
            var html = '<div class="sun-editor-id-toolbar-cover"></div>'+
                ...
                '    <ul class="editor_tool">';
                    if(options.showFont) {
                        ...
                        '            <button style="display: none;" type="button" class="btn_editor btn_font" title="'+lang.toolbar.fontFamily+'" data-display="sub">'+
            ...
            html +='</ul>'+
                ...
                if(options.showFontColor) {
                    ...
                    '                        <em class="color_font" style="background-color:#4B4F56"></em>'+
                    '                    </div>'+
                    '                </button>'+
                    '            </div>'+
                ...
                if(options.showHiliteColor) {
                    ...
                    '                            <li><button type="button" class="btn_color" style="color:#4B4F56;background-color:#cce9ff;">#cce9ff<span class="bg_check"></span><span class="bg_btnframe"></span></button></li>'+
                    '                            <li><button type="button" class="btn_color" style="color:#4B4F56;background-color:#fcfd4c;">#fcfd4c<span class="bg_check"></span><span class="bg_btnframe"></span></button></li>'+
                    '                            <li><button type="button" class="btn_color color_white" style="color:#4B4F56;background-color:#ffffff;">#ffffff<span class="bg_check"></span><span class="bg_btnframe"></span></button></li>'+
                    '                            <li><button type="button" class="btn_color" style="color:#4B4F56;background-color:#dfdede;">#dfdede<span class="bg_check"></span><span class="bg_btnframe"></span></button></li>'+
            ...
            html += '<div class="tool_module">'+
                ...
                if(options.showLine) {
                    ...
                    '                <hr style="border-width: 1px 0px 0px; border-style: solid none none; border-color: #4B4F56; border-image: initial; height: 1px;">'+
                    '                <hr style="border-width: 1px 0px 0px; border-style: dotted none none; border-color: #4B4F56; border-image: initial; height: 1px;">'+
                    '                <hr style="border-width: 1px 0px 0px; border-style: dashed none none; border-color: #4B4F56; border-image: initial; height: 1px;">'+
                    '            </button>'+
            ...
            if(options.showVideo) {
                html += ''+
                    '        <li>'+
                    '            <button class="btn_editor" title="'+lang.toolbar.video+'" style="margin-left: -3px;" data-display="modal" data-command="video">'+
    ...
    var Context = function(element, cons, options) {
        ...
        setTimeout(function(){
            cons._editorArea.getElementsByClassName('sun-editor-id-wysiwyg')[0].contentWindow.document.head.innerHTML = ''+
                '<meta charset=\"utf-8\">' +
                '<style type=\"text/css\">' +
                '   body {word-break:break-all; overflow:auto; font-family:sans-serif;} p {margin:0; padding:0;} blockquote {margin-top:0; margin-bottom:0; margin-right:0;}' +
                ...
                '   table tr td {border:1px solid #DADADA; padding:7px;}'+
                '</style>';
            ...
            cons._editorArea.getElementsByClassName('sun-editor-id-wysiwyg')[0].contentWindow.document.body.onclick = function(){
                //REMOVE ERROR NR.2
                    //src/path/dt/cs/index/js/js.js
                        document.getElementsByClassName("error_textjs")[0].classList.add("none");
                        document.getElementsByClassName("error_textjs")[0].innerHTML = "";
                        document.getElementsByClassName("sun-editor")[0].classList.remove("redisbs");
                        document.getElementsByClassName("sun-editor-id-editorArea")[0].classList.remove("redisbsh");
                        document.getElementsByClassName("sun-editor-id-editorArea")[0].classList.remove("redisbsto");
                        document.getElementsByClassName("sun-editor-id-editorArea")[0].classList.remove("redisbsbo");
            }
