<?php
    ...
    function get_articles_using_id($article_ids_array, $connect){
            ...
            if($result){
                ...
                if($row){
                    ...
                    echo "<!--START : WRAPP ITEM-->
                            <div class='history_window_center p l mb10 mt10'>
                                <!--START : ITEM-->
                                    <div class='liked_element_article_preview sh p l pa br12'>
                                        ...
                                        <!--START : WRAPP-->
                                            <div class='LEAP_title_text p l ml20'>
                                                <!--START : Title-->
                                                    <div class='LEAP_title w100 fw f24 c p l' title='". htmlspecialchars($row['title'], ENT_QUOTES) ."' onclick='show_article_in_extended_mode(".$article_id."), close_history_window_popup()'>
                                ...
                                <!--START : Remove/Share-->
                                    <div class='LEAP_remove_share ab dg alc pal'>
                                        <div class='LEAP_remove_btn br50 dg alc jcc c' onclick='remove_history_from_article(". $if++ .",".$article_id."001)'>
                                            <div class='LEAP_btnw'>
        ...
        echo "<div class='count_of_active_history_elements_js none'>". $if ."</div>";
            echo "<!--START : Session : true-->
                    <div class='puwsulik_history_session_true_js dg alc jcc hi none' style='width: 600px;'>
                        <div class='puwsu1 dg alc jcc'>
                            <div class='puwsu2 p'>
                                <div class='dg jcc w100'>
                                    <div class='puwsu4h w80 h80 bgsz80 bgnr'><!--icon--></div>
                                </div>
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        if(isset($_POST['load']) && $_POST['load'] === "1" && isset($_SESSION['user']['nickname'])){
            ...
            $id_of_liked_articles = mysqli_query($connect, "
                SELECT id_of_article, MAX(dateofpublication) AS latest_date
                FROM history
                WHERE nickname='$nickname' AND status='0'
            ...
            if($id_of_liked_articles){
                if(mysqli_num_rows($id_of_liked_articles) > 0){
                    ...
                    echo "  <!--START : Session : true-->
                                <div class='puwsulik_history_session_true_js dg alc jcc hi' style='width: 600px;'>
                                    <div class='puwsu1 dg alc jcc'>
                                        <div class='puwsu2 p'>
                                            <div class='dg jcc w100'>
                                                <div class='puwsu4h w80 h80 bgsz80 bgnr'><!--icon--></div>
